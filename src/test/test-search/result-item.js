...
const TestResultItem = ({result}) => {
    const resultTime = result.dates.start.localTime;
    ...
    return (
        <div className="card mb-2">
            <div className="row">
                <div className="col-3">
                    <img className="card-img" src={result.images[0].url} alt="poster"/>
                </div>
                <div className="col-9 mt-1 mb-0">
                    <div>
                        ...
                        <div className="fw-bold">
                            {result.dates.start.localDate} {localTime}
                        </div>
