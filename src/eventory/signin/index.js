                ...
                <div className="row login-row">
                    ...
                    <div className="col-md-6 login-signup-form">
                        <div className="login-signup-input-box">
                            <h4 className="finalproj-text-align-center mb-3 fw-bold">
                                Sign in to Eventory
                            </h4>
                            {signInStatus === 'rejected' && (
                                <div className="login-signup-input-field text-danger">
                                    {signInMessage.message}
                                </div>
                            )}
                            {signInStatus === 'pending' && (
                                <div className="login-signup-input-field text-secondary">
                                    Loading...
                                </div>
                            )}
                            ...
                            <div className="login-signup-input-field">
                                <input
                                    type="submit"
                                    className="login-signup-submit fw-bold mt-2 mb-4"
                                    value="Sign in"
                                />
                            </div>
