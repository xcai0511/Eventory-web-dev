        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container">
                <a className="navbar-brand" href="#">
                    <img src="../../../public/images/eventory-logo.png" alt="Eventory Event Management" width="60"></img>
                </a>
                ...
                <div className="collapse navbar-collapse" id="navigation-bar">
                    <ul className="navbar-nav mx-auto">
                        <Link to="/eventory/about/" className={`nav-item ms-lg-5 me-4
                            ${active === 'about'?'active':''}`}>
                            <div className="nav-link">About</div>
                        </Link>
                        <Link to="/eventory/exclusives/" className={`nav-item ms-lg-2 me-4
                    ...
                    <ul className="navbar-nav ms-auto">
                        <Link to="/eventory/signin/" className={`nav-item
                            ${active === 'signin'?'active':''}`}>
                            <div className="nav-link">Log in</div>
                        </Link>
                        <Link to="/eventory/signup/" className={`nav-item
